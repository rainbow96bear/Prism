...
func (p *ProfileHasTechListRepository) GetUserTechList(tx *sql.Tx, id string) ([]dto.UserTech, error) {
	...
	for rows.Next() {
		...
		userTechList = append(userTechList, userTech)
	}
